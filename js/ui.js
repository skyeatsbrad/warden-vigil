...
import { COMPANION_DEFS, DROPPABLE_COMPANIONS, MODIFIERS, getModifiersForType, EVOLUTIONS, getEvolveLevel, TRADEOFF_CARDS, CURSED_CARDS, MASTERY_DEFS, getMasteryValue } from './data/companions.js?v=12';
import { pick, weightedPick } from './utils.js?v=12';
