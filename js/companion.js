...
import { COMPANION_DEFS, getCompanionStats, MODIFIERS, EVOLUTIONS } from './data/companions.js?v=8';
import { dist, angle } from './utils.js?v=8';
import { GLOW, TRAIL } from './data/colors.js?v=8';
