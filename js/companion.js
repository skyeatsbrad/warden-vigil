...
import { COMPANION_DEFS, getCompanionStats, MODIFIERS, EVOLUTIONS } from './data/companions.js?v=5';
import { dist, angle } from './utils.js?v=5';
import { GLOW, TRAIL } from './data/colors.js?v=5';
